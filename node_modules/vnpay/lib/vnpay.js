...
class VNPay {
	constructor(_a) {
		var {
				...
				vnp_Version = constants_1.VNP_VERSION,
				vnp_CurrCode = enums_1.VnpCurrCode.VND,
				vnp_Locale = enums_1.VnpLocale.VN,
				testMode = false,
				paymentEndpoint = constants_1.PAYMENT_ENDPOINT,
			} = _a,
			config = __rest(_a, [
				"vnpayHost",
				"vnp_Version",
		...
		this.globalDefaultConfig = Object.assign(
			{
				vnpayHost,
				vnp_Version,
				vnp_CurrCode,
				...
				vnp_Command: constants_1.VNP_DEFAULT_COMMAND,
			},
			config,
		);
	}
		...
		return __awaiter(this, void 0, void 0, function* () {
			...
			const response = yield fetch(
				(0, common_1.resolveUrlString)(
					(_a = this.globalDefaultConfig.vnpayHost) !== null && _a !== void 0
						? _a
						: constants_1.VNPAY_GATEWAY_SANDBOX_HOST,
					constants_1.GET_BANK_LIST_ENDPOINT,
				),
				{
					method: "POST",
					headers: {
			...
			for (const bank of bankList) {
				bank.logo_link = (0, common_1.resolveUrlString)(
					(_b = this.globalDefaultConfig.vnpayHost) !== null && _b !== void 0
						? _b
						: constants_1.VNPAY_GATEWAY_SANDBOX_HOST,
	...
	buildPaymentUrl(data, options) {
		var _a;
		const dataToBuild = Object.assign(
			Object.assign(Object.assign({}, this.defaultConfig), data),
			{
				/**
		...
		if (
			(dataToBuild === null || dataToBuild === void 0
				? void 0
				: dataToBuild.vnp_ExpireDate) &&
			!(0, common_1.isValidVnpayDateFormat)(dataToBuild.vnp_ExpireDate)
		) {
		...
		if (
			!(0, common_1.isValidVnpayDateFormat)(
				(_a =
					dataToBuild === null || dataToBuild === void 0
						? void 0
						: dataToBuild.vnp_CreateDate) !== null && _a !== void 0
					? _a
					: 0,
			)
		) {
			const timeGMT7 = (0, common_1.getDateInGMT7)();
			dataToBuild.vnp_CreateDate = (0, common_1.dateFormat)(
				timeGMT7,
				"yyyyMMddHHmmss",
			);
		}
	...
	verifyReturnUrl(query, options) {
		var _a, _b, _c;
		const { vnp_SecureHash = "", vnp_SecureHashType } = query,
			cloneQuery = __rest(query, ["vnp_SecureHash", "vnp_SecureHashType"]);
		if (
			typeof (cloneQuery === null || cloneQuery === void 0
				? void 0
				: cloneQuery.vnp_Amount) !== "number"
		) {
			const isValidAmount = constants_1.numberRegex.test(
				(_a =
					cloneQuery === null || cloneQuery === void 0
						? void 0
						: cloneQuery.vnp_Amount) !== null && _a !== void 0
					? _a
					: "",
			);
			if (!isValidAmount) {
		...
		const searchParams = (0, payment_util_1.buildPaymentUrlSearchParams)(
			cloneQuery,
		);
		...
		let outputResults = {
			...
			message: (0, common_1.getResponseByStatusCode)(
				(_c =
					(_b = cloneQuery.vnp_ResponseCode) === null || _b === void 0
						? void 0
		...
		if (!isVerified) {
			outputResults = Object.assign(Object.assign({}, outputResults), {
				message: "Wrong checksum",
			});
		}
		const result = Object.assign(
			Object.assign(Object.assign({}, cloneQuery), outputResults),
			{ vnp_Amount: cloneQuery.vnp_Amount / 100 },
		);
		if (this.isEnableLog) {
			const data2Log = Object.assign(
				Object.assign(
					{ createdAt: new Date(), method: this.verifyReturnUrl.name },
					result,
				),
				{
					vnp_SecureHash: (
	...
	verifyIpnCall(query, options) {
		...
		const result = this.verifyReturnUrl(query, {
			logger: { loggerFn: utils_1.ignoreLogger },
		});
		if (this.isEnableLog) {
			let data2Log = Object.assign(
				{ createdAt: new Date(), method: this.verifyIpnCall.name },
				result,
			);
			if (options === null || options === void 0 ? void 0 : options.withHash) {
				data2Log = Object.assign(Object.assign({}, data2Log), {
					vnp_SecureHash: hash,
				});
			}
			this.logData(data2Log, options);
	...
	queryDr(query, options) {
		return __awaiter(this, void 0, void 0, function* () {
			...
			const dataQuery = Object.assign(
				{
					vnp_Version:
						(_a = this.globalDefaultConfig.vnp_Version) !== null &&
						_a !== void 0
							? _a
							: constants_1.VNP_VERSION,
				},
				query,
			);
			const url = new URL(
				(0, common_1.resolveUrlString)(
					(_b = this.globalDefaultConfig.vnpayHost) !== null && _b !== void 0
						? _b
						: constants_1.VNPAY_GATEWAY_SANDBOX_HOST,
					constants_1.QUERY_DR_REFUND_ENDPOINT,
				),
			);
			...
			const message = (0, common_1.getResponseByStatusCode)(
				(_d =
					(_c = responseData.vnp_ResponseCode) === null || _c === void 0
						? void 0
						: _c.toString()) !== null && _d !== void 0
					? _d
					: "",
				this.globalDefaultConfig.vnp_Locale,
				constants_1.QUERY_DR_RESPONSE_MAP,
			);
			let outputResults = Object.assign(
				Object.assign(
					{
						isVerified: true,
						isSuccess:
							responseData.vnp_ResponseCode === "00" ||
							responseData.vnp_ResponseCode === 0,
						message,
					},
					responseData,
				),
			...
			const stringToCreateHashOfResponse = [
				...
				.join("|")
				.replace(/undefined/g, "");
			const responseHashed = (0, common_1.hash)(
				this.globalDefaultConfig.secureSecret,
			...
			if (
				...
				responseHashed !== responseData.vnp_SecureHash
			) {
				outputResults = Object.assign(Object.assign({}, outputResults), {
					isVerified: false,
					message: (0, common_1.getResponseByStatusCode)(
						constants_1.WRONG_CHECKSUM_KEY,
						this.globalDefaultConfig.vnp_Locale,
						constants_1.QUERY_DR_RESPONSE_MAP,
					),
				});
			...
			if (this.isEnableLog) {
				const data2Log = Object.assign(
					{ createdAt: new Date(), method: this.queryDr.name },
					outputResults,
				);
				this.logData(data2Log, options);
			}
	...
	refund(data, options) {
		return __awaiter(this, void 0, void 0, function* () {
			...
			const dataQuery = Object.assign(Object.assign({}, data), {
				vnp_Command,
				vnp_Version: this.globalDefaultConfig.vnp_Version,
				vnp_TmnCode: this.globalDefaultConfig.tmnCode,
				vnp_Amount: data.vnp_Amount * 100,
			...
			const message = (0, common_1.getResponseByStatusCode)(
				(_c =
					(_b = responseData.vnp_ResponseCode) === null || _b === void 0
						? void 0
						: _b.toString()) !== null && _c !== void 0
					? _c
					: "",
				(_d = data === null || data === void 0 ? void 0 : data.vnp_Locale) !==
					null && _d !== void 0
					? _d
					: this.globalDefaultConfig.vnp_Locale,
				constants_1.REFUND_RESPONSE_MAP,
			);
			let outputResults = Object.assign(
				Object.assign(
					{
			...
			if (
				...
				const stringToCreateHashOfResponse = [
					...
					responseData.vnp_BankCode,
					responseData.vnp_PayDate,
					(_e = responseData.vnp_TransactionNo) !== null && _e !== void 0
						? _e
						: DEFAULT_TRANSACTION_NO_IF_NOT_EXIST,
					responseData.vnp_TransactionType,
					responseData.vnp_TransactionStatus,
					responseData.vnp_OrderInfo,
				]
			...
			if (this.isEnableLog) {
				const data2Log = Object.assign(
					{ createdAt: new Date(), method: this.refund.name },
					outputResults,
				);
				this.logData(data2Log, options);
			}
	...
	logData(data, options) {
		...
		(
			((_a =
				...
				null || _a === void 0
				? void 0
				: _a.loggerFn) || this.globalLoggerFn
		)(data);
	}
}
exports.VNPay = VNPay;
